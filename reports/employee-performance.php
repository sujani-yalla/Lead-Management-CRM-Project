...
LEFT JOIN call_logs c ON c.lead_id = l.id
...
if (isset($_GET['export'])) {
    ...
    header("Content-Disposition: attachment; filename=employee-performance-report.csv");
...
<div class="container-fluid p-4">
    ...
    <h3 class="mb-0">Employee Performance Report</h3>
