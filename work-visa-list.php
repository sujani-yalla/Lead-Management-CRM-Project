            ...
            <div class="row size-column">
                ...
                <div class="card">
                  <div class="card-header pb-0 card-no-border">
                    <h4>Work visa Data</h4><span>Tracks Work visa applicants, their application status, and travel dates for easy monitoring</span>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive custom-scrollbar">
                      <table class="display" id="basic-1">
                        ...
                        <td>WV<?= str_pad($row['id'], 3, "0", STR_PAD_LEFT) ?></td>

                        <td><?= htmlspecialchars($row['lead_name']) ?></td>

                        <td><?= htmlspecialchars($row['employee_name']) ?></td>

                        <td><?= htmlspecialchars($row['applying_country']) ?></td>

                        <td><?= htmlspecialchars($row['job_category']) ?></td>

                        <td><?= htmlspecialchars($row['experience_years']) ?> yrs</td>

                        <td><?= htmlspecialchars($row['english_test']) ?></td>
                       ...
                       if ($status == "Approved" || $status == "Travel Completed") {
                           $badgeClass = "bg-success";
                        } elseif ($status == "Rejected") {
                           $badgeClass = "bg-danger";
                        } elseif ($status == "Interview Scheduled" || $status == "Interview Cleared") {
                            $badgeClass = "bg-info";
                        } elseif ($status == "Docs Pending" || $status == "Decision Awaited") {
