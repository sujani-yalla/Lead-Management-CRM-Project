...
if ($role === 'employee') {
    $where = "WHERE legal_cases.created_by = '$userId'";
}

$query = "
    SELECT legal_cases.*, users.name AS employee_name
    FROM legal_cases
    JOIN users ON legal_cases.created_by = users.id
    $where
            ...
            <div class="row size-column">
                ...
                <div class="card">
                  <div class="card-header pb-0 card-no-border">
                    <h4>Cases Data</h4><span>Monitors client legal and CA work, documents, and case progress.</span>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive custom-scrollbar">
                      <table class="display" id="basic-1">
                        ...
                        <tr>
                            ...
                            <td><?php echo ucfirst(str_replace('_', ' ', $row['documents_status'])); ?></td>
                            <td><?php echo ucfirst(str_replace('_', ' ', $row['completion_status'])); ?></td>
                            <td><?php echo $row['remarks']; ?></td>
                               <td>

                                   <!-- EDIT BUTTON (Employee + Admin) -->
                                    <a href="legal-edit.php?id=<?= $row['id'] ?>" 
                                    ...
                                    <?php if ($role === 'admin') { ?>
                                        ...
                                        <form action="legal-delete.php" method="POST"
