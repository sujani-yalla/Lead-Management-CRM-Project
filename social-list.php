            ...
            <div class="row size-column">
                ...
                <div class="card">
                  <div class="card-header pb-0 card-no-border">
                    <h4>Posts Data</h4><span>Tracks social media posting details and status.</span>
                  </div>
                  <div class="card-body">
...
<?php if ($result->num_rows > 0): ?>
    <?php while ($row = $result->fetch_assoc()): ?>
        <tr>
            ...
            <td><?= ucfirst($row['posting_type']); ?></td>
            <td><?= ucfirst($row['content_status']); ?></td>
            <td><?= date("d-m-Y", strtotime($row['posting_date'])); ?></td>
            <td><?= date("h:i A", strtotime($row['posting_time'])); ?></td>
            <td>
              <a href="social-edit.php?id=<?= $row['id'] ?>" 
