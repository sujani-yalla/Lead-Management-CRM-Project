...
/* VERIFY PARENT WORK VISA EXISTS */
$checkStmt = $conn->prepare("SELECT id FROM work_visas WHERE id = ?");
$checkStmt->bind_param("i", $visa_id);
$checkStmt->execute();
...
$applied_company   = trim($_POST['applied_company']);
...
$comments           = trim($_POST['comments']);
    ...
    $stmt = $conn->prepare("
    INSERT INTO work_visa_direct
    (visa_id, employer_name, country, job_type, job_role, salary, applied_company,
     job_status, documents_required, documents_details, comments, created_at)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())
");
...
<head>
    ...
    <title>Direct Employer Jobs</title>
    <!-- Google font-->
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Direct Employer Jobs</h4>
                                </div>
                                <div class="card-body">
                                    <!-- Success Modal -->
                                    <form class="row g-3 needs-validation custom-input" method="POST" id="leadForm">
                                        <div class="col-md-4 position-relative">
                                            <label class="form-label" for="validationTooltip01">Employer Name</label>
                                            <input class="form-control" name="employer_name" type="text"
                                                placeholder="Company Name" required="">
                                            <div class="valid-tooltip">Looks good!</div>
                                        </div>
                                        <div class="col-md-4 position-relative">
                                            <label class="form-label" for="validationTooltip02">Country</label>
...
<input type="text" name="applied_company" class="form-control"
...
<div class="col-md-4" id="documents_text_div" style="display:none;">
